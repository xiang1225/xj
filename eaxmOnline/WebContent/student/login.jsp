...
<%@ page import="com.xj.dormain.*,com.xj.util.*,java.util.*"%>
<html>
...
<body bgColor="#eef8e0" leftMargin="0" topMargin="0" MARGINWIDTH="0" MARGINHEIGHT="0">
  ...
  <TR>
    ...
    <TD background=../images/crm_12.gif colSpan=6>
      <TABLE id=table1 cellSpacing=0 cellPadding=0 width="98%" border=0>
        ...
        <TR>
          <TD>
           <form name="adminlogin" action="<%=request.getContextPath()%>/LoginServlet" method="post">
  ...
  <%}else if(flag!=null&&flag.equals("submited"))
  {%>
    <script type="text/javascript">
    alert("你的试卷已提交!不能再考试!");
  </script>
  <%}
  else if(flag!=null&&flag.equals("nothing"))
     {
  %>
  <script type="text/javascript">
    alert("今日无考试安排，如需考试请联系管理员!");
  </script>
  <%}else if(flag!=null&&flag.equals("nobody"))
   
     {%>
  <script type="text/javascript">
    alert("用户名不存在,请去学生管理模块注册!");
  </script>
